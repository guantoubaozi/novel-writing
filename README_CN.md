...
你也可以通过 `/novel:style-import` 从获许可、公版或自有文本中抽象参考语言风格。样本只在本地留存，产物是定性为主的风格模板和回测报告；不会复制受保护正文，也不会覆盖人物级 voice。
...
- 用“全书人物核心档案—章节人物卡—场景临时画像”三层人物上下文保持人物个性，同时避免每章读取全部人物资料。
- 按阶段加载：写正文前只带入全书级约束和本章硬连续性，细微语言、动作与呼应在首轮修订中检查。
...
贯穿多章的人物使用全书人物核心档案，记录能够解释行为的成长背景、欲望、矛盾、关系、语言和身体习惯。每个选定章节只维护一张章节人物卡，记录实际出场人物的入场状态、本章目标、压力、知识边界、激活特质、关系姿态和离场变化。写场景时再从这两层派生临时画像，不必读取全书所有人物或其他章节人物卡。

写章节梗概时对齐全书人物弧线并建立章节人物卡；写正文时只读取出场人物的必要档案章节和会让场景根基出错的硬约束；第一遍修订再扩大证据范围，检查细微口吻、动作习惯、背景呼应、意象、描述和前后照应。这样能把更多上下文留给具体叙事和丰富描写。
